...
def printResults():
    print("-------------------LIGHTNING DUPLEX WITHOUT COIN TOSS SIMULATION ENDS--------------------")
...
for x in range(no_payments):
    ...
    if onewayChannel(alice, bob, amount_to_transfer):
        print("One way Transfer Occurred")
        print()
    else:
        lightningReset(alice, bob, amount_to_transfer)

    if onewayChannel(bob, alice, amount_to_transfer):
        print("One way Transfer Occurred")
        print()
    else:
        lightningReset(bob, alice, amount_to_transfer)
